spline_scalar_internal <- function(chain, y, x, z, groups, degree, n_knots, n.iter,
                                   ...
                                   s2_beta, s2_delta)
{
  ...
  for (i in 1:n.iter) {
    tmp <- update_betas_scalar(y=y, x=x, z=z, groups=groups, alpha=alpha,
...
spline_scalar_internal2 <- function(chain, y, x, z, groups, degree, n_knots, n.iter,
                                    n.burnin, n.thin, inits, n, n_q, n_G_q, n_k,
                                    grid, endpoints, phi1, psi1, phi2, psi2, s2_alpha,
                                    s2_beta, s2_delta)
{
  ...
  # run through each iteration
  for (i in 1:n.iter) {
    tmp <- update_betas_scalar2(y=y, x=x, z=z, groups=groups, alpha=alpha,
                                beta=beta, gamma=gamma, delta=delta,
                                sigma2=sigma2, sigma2_gamma=sigma2_gamma,
                                bs_beta=bs_beta, phi1=phi1, psi1=psi1,
                                phi2=phi2, psi2=psi2,
...
spline_scalar_internal3 <- function(chain, y, x, z, groups, degree, n_knots, n.iter,
                                    n.burnin, n.thin, inits, n, n_q, n_G_q, n_k,
                                    grid, endpoints, phi1, psi1, phi2, psi2, s2_alpha,
                                    s2_beta, s2_delta)
{
  ...
  # run through each iteration
  for (i in 1:n.iter) {
    tmp <- update_betas_scalar3(y=y, x=x, z=z, groups=groups, alpha=alpha,
                                beta=beta, gamma=gamma, delta=delta,
                                sigma2=sigma2, sigma2_gamma=sigma2_gamma,
                                bs_beta=bs_beta, phi1=phi1, psi1=psi1,
                                phi2=phi2, psi2=psi2,
...
spline_scalar_internal4 <- function(chain, y, x, z, groups, degree, n_knots, n.iter,
                                    n.burnin, n.thin, inits, n, n_q, n_G_q, n_k,
                                    grid, endpoints, phi1, psi1, phi2, psi2, s2_alpha,
                                    s2_beta, s2_delta)
{
  ...
  # run through each iteration
  for (i in 1:n.iter) {
    tmp <- update_betas_scalar4(y=y, x=x, z=z, groups=groups, alpha=alpha,
                                beta=beta, gamma=gamma, delta=delta,
                                sigma2=sigma2, sigma2_gamma=sigma2_gamma,
                                bs_beta=bs_beta, phi1=phi1, psi1=psi1,
                                phi2=phi2, psi2=psi2,
