...
splineScalarInternal5 <- function(chain, y, x, z, groups, degree, n_knots, n.iter,
                                  n.burnin, n.thin, inits, n, n_q, n_G_q, n_k,
                                  grid, endpoints, phi1, psi1, phi2, psi2, s2_alpha,
                                  s2_beta, s2_delta)
{
  ...
  # run through each iteration
  for (i in 1:n.iter) {
    tmp <- updateBetasScalar5(y=y, x=x, z=z, groups=groups, alpha=alpha,
                              beta=beta, gamma=gamma, delta=delta,
                              sigma2=sigma2, sigma2_gamma=sigma2_gamma,
                              bs_beta=bs_beta, phi1=phi1, psi1=psi1,
                              phi2=phi2, psi2=psi2,
...
splineScalarInternal6 <- function(chain, y, x, z, groups, degree, n_knots, n.iter,
                                  n.burnin, n.thin, inits, n, n_q, n_G_q, n_k,
                                  grid, endpoints, phi1, psi1, phi2, psi2, s2_alpha,
                                  s2_beta, s2_delta)
{
  ...
  # run through each iteration
  for (i in 1:n.iter) {
    tmp <- updateBetasScalar6(y=y, x=x, z=z, groups=groups, alpha=alpha,
                              beta=beta, gamma=gamma, delta=delta,
                              sigma2=sigma2, sigma2_gamma=sigma2_gamma,
                              bs_beta=bs_beta, phi1=phi1, psi1=psi1,
                              phi2=phi2, psi2=psi2,
