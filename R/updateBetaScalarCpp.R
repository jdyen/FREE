updateBetasScalar <- function(y, x, z, groups, alpha, beta, gamma, delta, sigma2, sigma2_gamma,
...
updateBetasScalar2 <- function(y, x, z, groups, alpha, beta, gamma, delta, sigma2, sigma2_gamma,
                                 bs_beta, phi1, psi1, phi2, psi2, s2_alpha, s2_beta, s2_delta,
                                 n_q, n_G_q) {
  # update alpha
  alpha <- sample_alpha_scalar(y=y, x=x, groups=groups, beta=beta, gamma=gamma, delta=delta,
...
updateBetasScalar3 <- function(y, x, z, groups, alpha, beta, gamma, delta, sigma2, sigma2_gamma,
                                 bs_beta, phi1, psi1, phi2, psi2, s2_alpha, s2_beta, s2_delta,
                                 n_q, n_G_q) {
  # update alpha
  alpha <- sample_alpha_scalar(y=y, x=x, groups=groups, beta=beta, gamma=gamma, delta=delta,
...
updateBetasScalar4 <- function(y, x, z, groups, alpha, beta, gamma, delta, sigma2, sigma2_gamma,
                                 bs_beta, phi1, psi1, phi2, psi2, s2_alpha, s2_beta, s2_delta,
                                 n_q, n_G_q) {
  # update alpha
  alpha <- sample_alpha_scalar(y=y, x=x, groups=groups, beta=beta, gamma=gamma, delta=delta,
...
updateBetasScalar5 <- function(y, x, z, groups, alpha, beta, gamma, delta, sigma2, sigma2_gamma,
                               bs_beta, phi1, psi1, phi2, psi2, s2_alpha, s2_beta, s2_delta,
                               n_q, n_G_q) {
  # update alpha
  alpha <- sample_alpha_scalar(y=y, x=x, groups=groups, beta=beta, gamma=gamma, delta=delta,
...
updateBetasScalar6 <- function(y, x, z, groups, alpha, beta, gamma, delta, sigma2, sigma2_gamma,
                               bs_beta, phi1, psi1, phi2, psi2, s2_alpha, s2_beta, s2_delta,
                               n_q, n_G_q) {
  # update alpha
  alpha <- sample_alpha_scalar(y=y, x=x, groups=groups, beta=beta, gamma=gamma, delta=delta,
